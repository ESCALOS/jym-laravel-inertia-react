    ...
    return (
        <React.Fragment>
            ...
            <div className="w-full lg:hidden">
                <div
                    className={`flex items-center nav-item cursor-pointer ${component.startsWith('Services') ? 'text-primary-500' : 'text-gray-700'}`}
    ...
    <nav className="px-4 mx-auto my-4">
      <div className="flex items-center justify-between lg:justify-around text-blue-gray-900">
        <Link href={route('home')}>
            ...
            >
            <img className="h-16" src="/logo.png" alt="Logo Servicos Ambientales J&M S.A.C." />
            </div>
        </Link>
