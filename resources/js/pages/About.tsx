...
export default function About() {
    ...
    return (
        <Layout>
            <Head title="Inicio" />
            <Breadcrumb imgPath="/images/banner1.webp" title="Nosotros" subtitle="Presentación Corporativa" />
            <div className="py-16 space-y-8">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <img className="w-full rounded-md" src="/images/banner3.webp" alt="b1" />
                        <img className="w-full rounded-md" src="/images/banner2.webp" alt="b2" />
                    </div>
                </div>
